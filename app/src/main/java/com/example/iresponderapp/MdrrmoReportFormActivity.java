...
public class MdrrmoReportFormActivity extends AppCompatActivity {
    ...
    private void addPatientCard() {
        ...
        setVitalRowLabel(view, R.id.rowBP, "BP", "120/80");
        setVitalRowLabel(view, R.id.rowPulseRate, "Pulse Rate", "bpm");
        setVitalRowLabel(view, R.id.rowRespRate, "Resp Rate", "/min");
        setVitalRowLabel(view, R.id.rowTemp, "Temp", "°C");
        setVitalRowLabel(view, R.id.rowSaO2, "SpO2", "%");
        setVitalRowLabel(view, R.id.rowCapRefillVital, "Cap Refill", "seconds");
        setVitalRowLabel(view, R.id.rowPain, "Pain (0-10)", "0-10");
        setVitalRowLabel(view, R.id.rowGlucose, "Glucose", "mg/dL");
        setVitalRowLabel(view, R.id.rowObsTime, "Obs Time", "1");
    ...
    private void setVitalRowLabel(View parent, int rowId, String label) {
        setVitalRowLabel(parent, rowId, label, null);
    }
    
    private void setVitalRowLabel(View parent, int rowId, String label, String hint) {
        View row = parent.findViewById(rowId);
        ((TextView) row.findViewById(R.id.lblParameter)).setText(label);
        if (hint != null) {
            ((EditText) row.findViewById(R.id.inputTime1)).setHint(hint);
            ((EditText) row.findViewById(R.id.inputTime2)).setHint(hint);
            ((EditText) row.findViewById(R.id.inputTime3)).setHint(hint);
        }
    }
